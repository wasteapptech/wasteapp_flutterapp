          ...
          child: Column(
            ...
            children: [
              ...
              GridView.count(
                ...
                crossAxisSpacing: 20,
                children: [
                  _teamMemberCard('John Doe', 'Team Lead',
                      'assets/images/team_member1.jpg'),
                  _teamMemberCard('Jane Smith', 'UX Designer',
                      'assets/images/team_member2.jpg'),
                  _teamMemberCard('David Brown', 'Developer',
                      'assets/images/team_member3.jpg'),
                  _teamMemberCard('Sarah Johnson', 'Content Manager',
              ...
              const ListTile(
                leading:  Icon(Icons.language, color: Color(0xFF2cac69)),
                title:  Text('Website'),
                subtitle:  Text('www.wasteapp.com'),
                contentPadding: EdgeInsets.zero,
              ),
